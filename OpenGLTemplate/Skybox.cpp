...
{
	//downloaded from http://www.custommapmakers.org/skyboxes.php (25 Feb 2017)
	//Additionally, I changed colour
	m_cubemapTexture.Create(
		"resources\\skyboxes\\underwater\\i1.png",
		"resources\\skyboxes\\underwater\\i3.png",
		"resources\\skyboxes\\underwater\\i6.png",
		"resources\\skyboxes\\underwater\\i2.png",
		"resources\\skyboxes\\underwater\\i5.png",
		"resources\\skyboxes\\underwater\\i4.png");
